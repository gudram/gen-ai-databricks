...
# MAGIC %md
# MAGIC # 🧪 Hands-On Lab: Chunking and Indexing for Retrieval-Augmented Generation (RAG)
# MAGIC
# MAGIC ## 🔍 Scenario
# MAGIC
...
# MAGIC %md
# MAGIC ## ⚙️ Step 1: Install Required Libraries
# MAGIC
...
# MAGIC
# MAGIC ### 📦 Libraries We're Installing:
# MAGIC
...
# MAGIC
# MAGIC ### 🔧 Why These Libraries Matter:
# MAGIC
...
# MAGIC %md
# MAGIC ## 📄 Step 2: Download Sample Documents to DBFS
# MAGIC
...
# MAGIC %md
# MAGIC ## 🧹 Step 3: Extract and Clean PDF Text
# MAGIC
...
# MAGIC
# MAGIC ### 🔧 Text Extraction Approach:
# MAGIC
...
# MAGIC %md
# MAGIC ## ✂️ Step 4: Apply Sentence-Level Chunking with Overlap
# MAGIC
...
# MAGIC
# MAGIC ### 📊 Metadata We're Capturing:
# MAGIC
...
# MAGIC %md
# MAGIC ## 🧠 Step 5: Create an Embedding Endpoint in Databricks
# MAGIC
...
# MAGIC
# MAGIC ### 🔧 Embedding Model Selection:
# MAGIC
...
# MAGIC
# MAGIC ### 📋 Steps to Create the Embedding Endpoint:
# MAGIC
# MAGIC 1. **Navigate to Serving** in your Databricks workspace:
# MAGIC    - Go to: `Workspace → Machine Learning → Serving Endpoints`
# MAGIC
...
# MAGIC %md
# MAGIC ## 🔢 Step 6: Generate Embeddings for Chunked Text
# MAGIC
...
# MAGIC %md
# MAGIC ## 💾 Step 7: Apply Embeddings and Save to Delta
# MAGIC
...
# MAGIC %md
# MAGIC ## 🧭 Step 8: Create a Vector Search Endpoint
# MAGIC
...
# MAGIC
# MAGIC ### 🎯 What is a Vector Search Endpoint?
# MAGIC
...
# MAGIC %md
# MAGIC ## 🗂️ Step 8.1: Register Embedded Delta Table
# MAGIC
...
# MAGIC %md
# MAGIC ## 🧠 Step 9: Create and Sync a Vector Search Index
# MAGIC
...
# MAGIC
# MAGIC ### 🎯 What is a Vector Search Index?
# MAGIC
...
# MAGIC
# MAGIC ### 📊 Delta Sync vs Direct Access:
# MAGIC
# MAGIC **Delta Sync Index** (what we're using):
# MAGIC - ✅ Automatically syncs with source table
# MAGIC - ✅ Handles incremental updates efficiently
# MAGIC - ✅ Easier to manage and maintain
# MAGIC - ✅ Best for most use cases
# MAGIC
...
# MAGIC %md
# MAGIC ## 🔍 Step 10: Perform Semantic Search Queries
# MAGIC
...
# MAGIC %md
# MAGIC ## 🔀 Step 11: Compare Retrieval With and Without Chunk Overlap
# MAGIC
...
# MAGIC %md
# MAGIC ## 📊 Step 11.1: Create Index for No-Overlap Chunks
# MAGIC
...
# MAGIC %md
# MAGIC ## 📏 Step 12: Evaluate Chunk Size Effects on Retrieval Precision
# MAGIC
...
# MAGIC %md
# MAGIC ## 📊 Understanding Precision by Chunk Size
# MAGIC
...
# MAGIC    - ❌ Often too fragmented to capture complete thoughts
# MAGIC    - ❌ May miss context needed for accurate retrieval
# MAGIC    - ✅ Can be useful for very specific, keyword-focused queries
# MAGIC
# MAGIC 2. **Medium Chunks (150-300 words)**:
# MAGIC    - ✅ Typically optimal for most RAG applications
# MAGIC    - ✅ Balance between focus and context
# MAGIC    - ✅ Align well with typical question scope
# MAGIC    - ✅ Efficient use of LLM context window
# MAGIC
# MAGIC 3. **Large Chunks (600+ words)**:
# MAGIC    - ✅ Provide extensive context
# MAGIC    - ❌ May include irrelevant information (noise)
# MAGIC    - ❌ Consume more LLM tokens
# MAGIC    - ⚠️ Can reduce precision due to dilution
# MAGIC
...
# MAGIC %md
# MAGIC ## 🔀 Step 13: Implement Hybrid Search Strategy
# MAGIC
...
# MAGIC - ✅ Finds conceptually similar content
# MAGIC - ✅ Handles paraphrasing and synonyms
# MAGIC - ❌ May miss exact term matches
# MAGIC - ❌ Can be affected by embedding quality
# MAGIC
# MAGIC **Keyword Search** (lexical):
# MAGIC - ✅ Guarantees exact term matches
# MAGIC - ✅ Fast and deterministic
# MAGIC - ❌ Misses semantic similarity
# MAGIC - ❌ Sensitive to exact wording
# MAGIC
# MAGIC **Hybrid Approach**:
# MAGIC - ✅ Best of both worlds
# MAGIC - ✅ Fallback mechanism for reliability
# MAGIC - ✅ Can combine and rerank results
# MAGIC - ✅ More robust to edge cases
# MAGIC
...
# MAGIC %md
# MAGIC ## 🎓 Lab Wrap-Up: Key Learnings and Next Steps
# MAGIC
...
# MAGIC |------|-------------|--------------|
# MAGIC | 📥 **Document Ingestion** | Downloaded and extracted text from medical PDFs | Text extraction quality impacts downstream performance |
# MAGIC | 🧹 **Text Cleaning** | Removed noise and normalized formatting | Clean data = better embeddings and retrieval |
# MAGIC | ✂️ **Chunking** | Applied sentence-based chunking with overlap | Overlap preserves context at chunk boundaries |
# MAGIC | 💾 **Delta Lake Storage** | Saved chunks with metadata in Delta format | Delta provides ACID guarantees and versioning |
# MAGIC | 🧠 **Embedding Generation** | Created vector embeddings using BGE model | Embeddings capture semantic meaning for similarity search |
# MAGIC | 🔍 **Vector Search** | Built and queried vector search indexes | Enables fast semantic retrieval at scale |
# MAGIC | 🔀 **Overlap Comparison** | Compared retrieval with/without overlap | Overlap improves completeness but adds redundancy |
# MAGIC | 📏 **Chunk Size Analysis** | Evaluated precision across different sizes | Medium chunks (150-300 words) often optimal |
# MAGIC | 🔄 **Hybrid Search** | Combined semantic and keyword search | Hybrid approaches improve robustness |
# MAGIC
# MAGIC ---
# MAGIC
